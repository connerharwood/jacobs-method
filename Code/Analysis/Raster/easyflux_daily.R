...
easyflux_daily = easyflux_30min |> 
  ...
  select(station, lat, lon, year, month, day, et_mm_easyflux) |> 
  filter(!(year == 2025 & month == 10 & day == 10))

# ==== SAVE ====================================================================

save(easyflux_daily, file = "Data/Misc/EasyFlux vs. OpenET/easyflux_daily.rda")
