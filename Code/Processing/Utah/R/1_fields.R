...
rooting_depth_wrlu = read_excel("Data/Misc/rooting_depth.xlsx", sheet = "wrlu")
rooting_depth_cdl = read_excel("Data/Misc/rooting_depth.xlsx", sheet = "cdl") |> 
  filter(utah == 1)
...
cdl_wrlu_proportions = wrlu_harmonized |> 
  ...
  filter(crop_cdl %in% rooting_depth_cdl$crop) |> 
