...
load("Data/Clean/Depletion/Montana/masterdata.rda")
...
save(depletion_monthly, file = "Data/Clean/Depletion/Montana/depletion_monthly.rda")
save(depletion_annual, file = "Data/Clean/Depletion/Montana/depletion_annual.rda")
