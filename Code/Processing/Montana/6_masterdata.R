...
# Load 2008-2024 Montana fields panel
fields_panel = st_read("Data/Clean/Fields/Montana/fields_panel.shp") |> 
  st_drop_geometry()

load("Data/Clean/Input Data/Montana/ssurgo.rda") # Soil data
load("Data/Clean/Input Data/Montana/prism.rda") # Monthly precipitation data
load("Data/Clean/Input Data/Montana/openet_eemetric.rda") # Monthly ET data
...
save(masterdata, file = "Data/Clean/Depletion/Montana/masterdata.rda")
