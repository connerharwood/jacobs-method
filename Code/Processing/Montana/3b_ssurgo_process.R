...
# Load fields panel
fields = st_read("Data/Clean/Fields/Montana/fields_panel.shp") |> 
...
mu_polys = st_read("Data/Raw/SSURGO/Montana/ssurgo_mt.gpkg", layer = "mu_polys") |> 
  # Transform to NAD83 for spatial operations
  st_transform(crs = 26912)

# Load component percents
co_pct = st_read("Data/Raw/SSURGO/Montana/ssurgo_mt.gpkg", layer = "co_pct")

# Load component restrictions
co_restrictions = st_read("Data/Raw/SSURGO/Montana/ssurgo_mt.gpkg", layer = "co_restrictions")

# Load map unit aggregated attribute data
mu_aggatt = st_read("Data/Raw/SSURGO/Montana/ssurgo_mt.gpkg", layer = "mu_aggatt")
...
save(ssurgo, file = "Data/Clean/Input Data/Montana/ssurgo.rda")
