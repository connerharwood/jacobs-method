...
st_write(mu_polys, "Data/Raw/SSURGO/Montana/ssurgo_mt.gpkg", layer = "mu_polys", delete_layer = TRUE)
...
st_write(co_pct, "Data/Raw/SSURGO/Montana/ssurgo_mt.gpkg", layer = "co_pct", delete_layer = TRUE)
...
st_write(co_restrictions, "Data/Raw/SSURGO/Montana/ssurgo_mt.gpkg", layer = "co_restrictions", delete_layer = TRUE)
...
st_write(mu_aggatt, "Data/Raw/SSURGO/Montana/ssurgo_mt.gpkg", layer = "mu_aggatt", delete_layer = TRUE)
